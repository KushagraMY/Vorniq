...
INSERT INTO attendance (employee_id, date, clock_in_time, status) VALUES (1, CURRENT_DATE, NOW() - INTERVAL '2 hour', 'present');
INSERT INTO attendance (employee_id, date, clock_in_time, status) VALUES (2, CURRENT_DATE, NOW() - INTERVAL '1 hour' - INTERVAL '45 minute', 'present');
INSERT INTO attendance (employee_id, date, clock_in_time, status) VALUES (3, CURRENT_DATE, NOW() - INTERVAL '1 hour' - INTERVAL '30 minute', 'present');
INSERT INTO attendance (employee_id, date, clock_in_time, status) VALUES (5, CURRENT_DATE, NOW() - INTERVAL '1 hour' - INTERVAL '15 minute', 'present');
INSERT INTO attendance (employee_id, date, clock_in_time, status) VALUES (6, CURRENT_DATE, NOW() - INTERVAL '1 hour', 'present');
