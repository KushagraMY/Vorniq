...
import { FileText, Plus, Search, Filter, Send, Eye, Edit, Trash2, Download, CreditCard } from 'lucide-react';
...
export default function InvoiceManagement() {
      ...
      const mockInvoices: Invoice[] = [
        {
          ...
          customer_address: '123 Business Street, Mumbai, India',
        ...
        },
        {
          ...
          customer_address: '456 Innovation Hub, Delhi, India',
  ...
  const totalOutstanding = invoices.reduce((sum, inv) => sum + (inv.total_amount - inv.paid_amount), 0);
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left px-6 py-3 text-sm font-medium text-gray-900">Invoice</th>
                ...
                <th className="text-left px-6 py-3 text-sm font-medium text-gray-900">Due Date</th>
